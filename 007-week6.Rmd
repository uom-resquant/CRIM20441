...
Then you can also select the colur scheme that is most appropriate for your variable. If you have ordinal categories for example, then you could use a sequential scale - going from dark blue to light blue. On the other hand, if you have nominal variable, then a sequential colour scale would not make sense. In this case you would use a qualitative scale. Diverging you would use in a case when you have a middle value. For example temperature, you could have 0 degrees in the middle (white) and positive degrees as red, while negative degrees as blue. If you are unsure why this is the case, raise your hand now, and we can help explain. 
