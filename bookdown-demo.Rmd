...
Under the column headers you have your **420082** rows, one for each of the **420082** crimes in your data. Recall that these are your **observations**. Also, that therefore your **unit of analysis** in this data at this moment is each individual crime. 
...
You will see a third column appear, identical to the second one, with the frequencies. To turn this into percent values, click on the little downwards arrow on the yellow box of the value you just dragged into the values box (**some of these steps may look slightly different if you are working on a Mac**): 
