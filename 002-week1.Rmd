...
### If you use computer cluster PCs

You need to make sure that everything you are working on is saved in you [**P:drive**](https://www.library.manchester.ac.uk/using-the-library/staff/research/research-data-management/working/storage/). 
...
All cluster PCs already have Excel installed. However, if you are following along on your own laptop (I encourage this strongly) you can download microsoft excel **for free**, courtesy of the UoM library. [Follow the instructions here to get Microsoft Office on your laptops](http://www.itservices.manchester.ac.uk/students/office365/). 
