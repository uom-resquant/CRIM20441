...
<span style="color:#d95f02"> Label the new folder 'CRIM20441'. You will now have a series of folders in your p: drive (some of these you haven't created yourself, they have been provided for you by the university), one of which you can store course material in. 
...
Now because cluster PCs come pre-installed with EXcel you can skip the next section 1.5.1 and go straight to "1.5.2 Install data analysis toolpak". 
