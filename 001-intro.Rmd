...
Lab sessions are the two-hour sessions which take place synchronously (live). These will be held on Zoom. Details on how to access these can be found on [Blackboard](https://online.manchester.ac.uk/webapps/blackboard/content/listContentEditable.jsp?content_id=_11848920_1&course_id=_62746_1). In these labs we work together in groups through the lab notes included in this book. You should take time to engage with these notes, and ask lots of questions from myself and the teaching assistants present. This is a time to really engage with the materials. 
