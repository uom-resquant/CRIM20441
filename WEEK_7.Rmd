...
First, navigate to the 'Maps' tool. You can access maps via the Navigation Pane on the left if you want. Another (maybe easier) way is to navigate to the 'Explore' tab in your ribbon, and then selecting 'Mind Map'.

![](imgs/access_mind_map.png)

You can then name it. Call it "Deductive Approach to Probation Interview Data". You should end up with the following:
