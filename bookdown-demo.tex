...
And we also use this information for research and practice. Thus, \emph{qualitative data} refers to any type of non-numeric information, which can include interview transcripts, written notes, video and audio recordings, images and other types of text documents. We will learn here that we can also extract meaningful information from those - and use it in our research.
...
\hypertarget{activity-1-watch-nvivo-tutorials}{%
\subsection{Activity 1: Watch NVivo tutorials}\label{activity-1-watch-nvivo-tutorials}}
