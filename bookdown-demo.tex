...
\hypersetup{
  ...
  pdfauthor={Reka Solymosi (maintained by David Buil-Gil and Nicolas Trajtenberg)},
  hidelinks,
...
\hypertarget{but-hows-qualitative-data-different-from-quantitative-data}{%
\subsection{But how's qualitative data different from quantitative data?}\label{but-hows-qualitative-data-different-from-quantitative-data}}
...
\subsection{Activity 2: Find some data\ldots{}}\label{activity-2-find-some-data}}
...
\subsection{Activity 3: Getting started with NVivo}\label{activity-3-getting-started-with-nvivo}}
...
\textbf{Note 5}: \emph{Edit mode/Read only mode} - note that it is always possible to make changes to textual documents once you've imported them, but unless you change the default option, your files by default will be in protected Read only format when on display in the Detail View.
...
\subsection{Activity 7: Word frequency}\label{activity-7-word-frequency}}
...
\includegraphics{imgs/freq_words.png}
...
\includegraphics{imgs/word_cloud.jpg}
...
\includegraphics{imgs/word_cloud2.png}
