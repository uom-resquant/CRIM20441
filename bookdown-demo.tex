...
You can download two snapshots of two different suspicious activity reports from Blackboard (``Data for labs and homework'' -\textgreater{} ``FinCEN files'' -\textgreater{} ``suspicious activity report snapshot 1'' and ``suspicious activity report snapshot 2''). Read through them and start thinking how you would use all this qualitative data for research.
