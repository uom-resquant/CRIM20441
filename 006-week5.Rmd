...
Once you have downloaded the data, open it with excel, and have a look at it. You can see that we have 94 rows, one for each student. You can also see that we have 3 variables: ID, Name, and Programme. 
...
If all goes well, your pivot table should let you know that you have 47 students in your control group, and that minus 94 (your total) students in your treatment group (also 47): 
