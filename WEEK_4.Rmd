...
But first, to calculate the z-score, our data needs to meet some assumptions. First, it needs to be a numeric variable. To be fair, though, in order to calculate a mean and a standard deviation in the first place, we needed this variable to be numeric. But the other assumption it makes is that this numeric variable follows a **normal distribution**. You might remember this concept from the very first week when you watched the [joy of stats](http://www.gapminder.org/videos/the-joy-of-stats/) video by Hans Rosling. If you didn't watch it, you definitely should! But in any case, here's a quick video to re-cap normal distribution to you, this time by Chris Wilde: 
