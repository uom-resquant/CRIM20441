...
In the pop-up that appears under the series box, click on the "Add" button:
...
Once you click on the "Add" button, the fields for "Name"/ "Series name" and "Y values"/ "Series values" should appear empty. Click in the text box next to the name, and then click on the column header (variable name) for the next variable. Select "Robbery Rate":
...
You could also create a stacked column chart that shows you the cumulative crime rate in each year, while separating out categories, using all the same variables. 
...
And again, this will bring up a pop-up. Here, once again, you can add variables with the "Add" button: 
...
By becoming a maker of good graphs, you should also become literate about graphs. If you are interested in a role as a crime analyst, part of your interview process includes a numeracy test, which will test your ability to interpret trends and data from graphs (among other things). 
