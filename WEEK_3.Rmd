...
For example, if we are calculating the median age for assault for every line, we first need to make sure that the value in the *reason for arrest* column is equal to *assault*. If it is, then we use that person's age to calculate the median age. If it is not, we do not. 
